"""Resumable request execution, retry handling, and multi-turn revision workflows."""
...
from .backends import BackendError, BackendTimeout, InferenceBackend
...
class ExperimentExecutor:
    ...
    def _execute(self, request: ExperimentRequest) -> ExperimentResult:
        ...
        if request.experiment == "exp10":
            return self._execute_revision(request, started)
    ...
    def _execute_revision(self, request: ExperimentRequest, started: str) -> ExperimentResult:
        ...
        stages.append({"stage": "initial", "generation": _generation_dict(generation), "evaluation": evaluation})
